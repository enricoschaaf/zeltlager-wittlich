        ...
        <div className="z-10 grid items-center justify-center max-w-4xl gap-y-4 sm:gap-y-6">
          ...
          <div className="prose sm:prose-lg">
            ...
            <p style={{ textAlign: "justify" }}>
              In der Zeit von Sonntag, 04.08., bis Mittwoch, 14.08.2024, weht
              das Löwenbanner dieses Mal auf dem Jugendzeltplatz Wershofen. Wenn
              ihr zur Zeit des Zeltlagers zwischen 9 und 15 Jahre alt seid und
              jede Menge Spaß und Gemeinschaft unter freiem Himmel erleben
              möchtet, dann seid ihr hier richtig. Meldet euch so bald wie
              möglich an!
              <br />
              <br />
              Der Teilnehmendenbeitrag beträgt zwischen 180€ und 220€. Familien
              zeigen sich mit Familien solidarisch, deshalb bezahlen Sie, was
              Sie geben können. Werden mehrere Kinder einer Familie angemeldet,
              so wird ab dem zweiten Kind ein reduzierter Beitrag zwischen 140€
              und 180€ erhoben. KjG - Mitglieder zahlen 11€ weniger. Enthalten
              sind sämtliche anfallenden Kosten für Anreise, Unterbringung,
