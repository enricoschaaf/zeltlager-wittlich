...
const Privacy = () => (
  <div className="prose marker:prose-ul:text-emerald-500 m-auto p-4">
    <h1>Datenschutz</h1>
    <h2>
    ...
    <p>
      ...
      personenbezogenen Daten zu gewährleisten. Als privatrechtliches
      Unternehmen unterliegen wir den Bestimmungen der europäischen
      Datenschutzgrundverordnung (DSGVO) und den Regelungen des
    ...
    <p>
      <b>1. Personenbezogene Daten</b> <br /> "Personenbezogene Daten" sind alle
    ...
    <p>
      <b>2. Verarbeitung</b> <br /> "Verarbeitung" ist jeder, mit oder ohne
    ...
    <p>
      <b>3. Einschränkung der Verarbeitung</b> <br /> "Einschränkung der
      Verarbeitung" ist die Markierung gespeicherter personenbezogener Daten mit
      dem Ziel, ihre künftige Verarbeitung einzuschränken.
    </p>
    <p>
      <b>4. Profiling</b> <br /> "Profiling" ist jede Art der automatisierten
    ...
    <p>
      <b>5. Pseudonymisierung</b> <br /> "Pseudonymisierung" ist die
    ...
    <p>
      <b>6. Dateisystem</b> <br /> "Dateisystem" ist jede strukturierte Sammlung
    ...
    <p>
      <b>7. Verantwortlicher</b> <br /> "Verantwortlicher" ist eine natürliche
    ...
    <p>
      <b>11. Einwilligung</b> <br /> Eine "Einwilligung" der betroffenen Person
      ist jede freiwillig für den bestimmten Fall, in informierter Weise und
    ...
    <p>
      ...
      Verarbeitung können gemäß Artikel 6 Abs. 1 lit. a – f DSGVO insbesondere
      sein:
    </p>
    <ul>
      <li>
    ...
    <p>
      <b>(1)</b> Im Folgenden informieren wir über die Erhebung
      personenbezogener Daten bei Nutzung unserer Website. Personenbezogene
      Daten sind z. B. Name, Adresse, E-Mail-Adressen, Nutzerverhalten.
    </p>
    <p>
      <b>(2)</b> Bei einer Kontaktaufnahme zur mit uns per E-Mail oder über ein
      ...
      oder die Verarbeitung wird eingeschränkt, falls gesetzliche
    ...
    <p>
      <b>(1)</b> Zusätzlich zu den zuvor genannten Daten werden bei der Nutzung
    ...
    <p>
      <b>(2)</b> Diese Website nutzt folgende Arten von Cookies, deren Umfang
    ...
    <p>
      <b>a.</b> Transiente Cookies werden automatisiert gelöscht, wenn Sie den
    ...
    <p>
      <b>b.</b> Persistente Cookies werden automatisiert nach einer vorgegebenen
    ...
    <p>
      <b>c.</b> Sie können Ihre Browser-Einstellung entsprechend Ihren Wünschen
      konfigurieren und z. B. die Annahme von Third-Party-Cookies oder allen
      Cookies ablehnen. Sog. "Third Party Cookies" sind Cookies, die durch einen
      Dritten gesetzt wurden, folglich nicht durch die eigentliche Website auf
      der man sich gerade befindet. Wir weisen Sie darauf hin, dass Sie durch
      die Deaktivierung von Cookies eventuell nicht alle Funktionen dieser
    ...
    <p>
      <b>(1) Widerruf der Einwilligung</b> <br />
      ...
      nicht berührt. Für die Ausübung des Widerrufsrechts können Sie sich
      jederzeit an uns wenden.
    </p>
    <p>
      <b>(2) Recht auf Bestätigung</b> <br />
    ...
    <p>
      <b>(3) Auskunftsrecht</b> <br /> Sofern personenbezogene Daten verarbeitet
      werden, können Sie jederzeit Auskunft über diese personenbezogenen Daten
      und über folgenden Informationen verlangen:
    </p>
    <ul>
      ...
      <li>
        ...
        internationalen Organisationen; falls möglich, die geplante Dauer, für
    ...
    <p>
      <b>(4) Recht auf Berichtigung</b> <br /> Sie haben das Recht, von uns
      ...
      der Verarbeitung haben Sie das Recht, die Vervollständigung
      unvollständiger personenbezogener Daten – auch mittels einer ergänzenden
      Erklärung – zu verlangen.
    </p>
    <p>
      <b>(5) Recht auf Löschung ("Recht auf vergessen werden")</b> <br /> Sie
      haben das Recht, von dem Verantwortlichen zu verlangen, dass Sie
    ...
    <ul>
      ...
      <li>
        ...
        Artikel 21 Absatz 2 DSGVO Widerspruch gegen die Verarbeitung ein. Die
    ...
    <p>
      ...
      soweit die Verarbeitung erforderlich ist: zur Ausübung des Rechts auf
    ...
    <ul>
      ...
      <li>
        ...
        unmöglich macht oder ernsthaft beeinträchtigt, oder zur Geltendmachung,
        Ausübung oder Verteidigung von Rechtsansprüchen.
      </li>
    </ul>

    <p>
      <b>(6) Recht auf Einschränkung der Verarbeitung</b> <br /> Sie haben das
    ...
    <p>
      <b>(7) Recht auf Datenübertragbarkeit</b> <br /> Sie haben das Recht, die
    ...
    <p>
      <b>(10) Recht auf Beschwerde bei einer Aufsichtsbehörde</b> <br /> Sie
      haben zudem, unbeschadet eines anderweitigen verwaltungsrechtlichen oder
    ...
    <p>
      <b>(11) Recht auf wirksamen gerichtlichen Rechtsbehelf</b> <br /> Sie
      ...
      bei einer Aufsichtsbehörde gemäß Artikel 77 DSGVO das Recht auf einen
      wirksamen gerichtlichen Rechtsbehelf, wenn sie der Ansicht ist, dass die
      ihr aufgrund dieser Verordnung zustehenden Rechte infolge einer nicht im
      Einklang mit dieser Verordnung stehenden Verarbeitung ihrer
